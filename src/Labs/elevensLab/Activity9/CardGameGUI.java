package Labs.elevensLab.Activity9;
...
public class CardGameGUI extends JFrame implements ActionListener {
    ...
    public void repaint() {
        for (int k = 0; k < board.size(); k++) {
            ...
            URL imageURL = getClass().getResource("C:\\Users\\H4lz0un\\IdeaProjects\\CompSciJavaMethods\\src\\Labs\\elevensLab\\Activity9\\cards\\" + cardImageFileName);
            if (imageURL != null) {
