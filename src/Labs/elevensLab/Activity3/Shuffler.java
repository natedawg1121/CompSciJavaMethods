package Labs.elevensLab.Activity3;

public class Shuffler {

    private static final int shuffleCount = 2;    //The number of shuffles to be implemented.
    ...
    public static void main(String[] args) {
        ...
        for (int j = 1; j <= shuffleCount; j++) {
            ...
            System.out.print("  " + j + ":");
            for (int beebop : values1) {
                System.out.print(" " + beebop);
            }
            System.out.println();
        }
        System.out.println();
