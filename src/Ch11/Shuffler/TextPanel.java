...
public class TextPanel extends JPanel implements MouseInputListener, ActionListener {
    ...
    public void moveLine() {
        if (selectedLine >= 0 && selectedLine < textLines.size() && toLine >= 0 && toLine <= textLines.size() && selectedLine != toLine) {
            int newIndex = toLine;
            if (selectedLine < newIndex) newIndex--;
