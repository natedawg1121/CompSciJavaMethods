...
//        for (int[] boop : grid)
//            System.out.println(Arrays.toString(boop));
    }
        ...
        if (sCell % cols == 1) {
            ...
            while (nCol != 1) {
                if (nCol > 2 && grid[InRow][InCol - 1] != 0 && grid[InRow][InCol - 2] != 0 && nextPiece == 1) {
                    ...
                    nextPiece++;
                    nCell -= 21;
                } else if (nRow > 1 && nCol > 1 && grid[InCol - 1][InRow] != 0 && grid[InRow - 1][InCol - 1] != 0 && nextPiece == 3 && !aufWiedersehen.get(aufWiedersehen.size() - 1).equals("DB")) {
                    aufWiedersehen.add("C");
                    System.out.print("C");
                    nextPiece++;
                    nCell -= 12;
                } else if (nRow > 2 && nCol > 1 && grid[InRow - 1][InCol] != 0 && grid[InRow - 2][InCol] != 0 && grid[InRow - 2][InCol - 1] != 0 && nextPiece == 4) {
                    aufWiedersehen.add("D");
                    System.out.print("D");
                    nextPiece++;
                    nCell -= 22;
