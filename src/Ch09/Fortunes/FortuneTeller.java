...
public class FortuneTeller extends JFrame implements ActionListener {
    ...
    public FortuneTeller() {
        ...
        display = new JTextField("  Press \"Next\" to see your fortune...", 90);
    ...
    public void actionPerformed(ActionEvent e) { //Pick and display a random fortune:
        Random generator = new Random();
        String finalFortune = fortuneArray[generator.nextInt(101)];
        display.setText("  " + finalFortune);
        ding.play();
    }
    public static void main(String[] args) {
        JFrame window = new FortuneTeller();
        window.setBounds(300, 300, 1000, 100);
